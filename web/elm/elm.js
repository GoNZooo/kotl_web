...
Elm.Monitor.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = A2($Html.div,_U.list([]),_U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("hej")])),A2($Html.p,_U.list([]),_U.list([$Html.text("hopp")]))]));
   return _elm.Monitor.values = {_op: _op,main: main};
};
